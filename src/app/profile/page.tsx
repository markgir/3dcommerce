...
export default function ProfilePage() {
  ...
  if (!session) {
    return (
      <div className="max-w-lg mx-auto px-4 py-16 text-center">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-4">{t('profile.signInToView')}</h2>
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 mb-8">
          ...
          <div className="flex-1">
            ...
            {userData?.createdAt && (
              <p className="text-gray-400 text-xs mt-1 flex items-center gap-1">
                ...
                {t('profile.joined')} {new Date(userData.createdAt).toLocaleDateString('en-US', { year: 'numeric', month: 'long' })}
              </p>
            )}
          </div>
          <Link
        ...
        <div className="grid grid-cols-3 gap-4 mt-6 pt-6 border-t border-gray-100">
          <div className="text-center">
            ...
            <div className="text-xs text-gray-400">{t('profile.models')}</div>
          </div>
          <div className="text-center">
      ...
      {/* Models */}
      <h2 className="text-xl font-bold text-gray-900 mb-4">{t('profile.myModels')}</h2>
      {userData?.models && userData.models.length > 0 ? (
        ...
        <div className="text-center py-16 bg-white rounded-2xl border border-gray-100">
          ...
          <p className="text-gray-400 mb-4">{t('profile.noModelsUploaded')}</p>
